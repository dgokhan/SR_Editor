...
{
    public partial class FormSqlTanim : FormBase, IFormBase
    {
        ...
        //private IDapperRepository<SqlTanimKategori> _sqlTanimKategoriRepository;
        //private IDapperRepository<SqlTanim> _sqlTanimRepository;
        //private IDapperRepository<SqlTanimKosul> _sqlTanimKosulRepository;
        //private IDbConnection _sqlTanimConnection;
        //private IDapperRepository<SqlTanimParametre> _sqlTanimParametreRepository;
        ...
        public void InitLookUp()
        {
            ...
            try
            {
                ...
                this.lookUpEditServer.Properties.DataSource = shards.ToList();
            }
            catch (ApiException exception)
            {
                UtilMessage.Show(exception.Message);
        ...
        protected override bool Kaydet()
        {
            ...
            foreach (Control item in this.xtraScrollableControlKosullar.Controls)
            {
                ...
                if (kosul.textEditKosulAdi.EditValue.IsNull())
                    throw new ExceptionBeklenmeyen("Koşul adı boş olamaz.");
                if (kosul.numericUpDownKosulOncelik.Value.IsNull())
                    throw new ExceptionBeklenmeyen("Koşul önceliği boş olamaz.");
                if (kosul.richEditControlSorgu.IsNull())
                    throw new ExceptionBeklenmeyen("Koşul sorgusu boş olamaz.");
                if (kosul.radioGroupKosulIslemDevam.EditValue.IsNull())
                    throw new ExceptionBeklenmeyen("Koşul'un işlem devamlılığı boş olamaz.");
                if (kosul.radioGroupKosulSonuc.EditValue.IsNull())
                    throw new ExceptionBeklenmeyen("Koşul'un sonucu boş olamaz.");
            }
            ...
            foreach (var keyValuePair in this.paramDictionary)
            {
                ...
                {
                    var api = new RoyaleSupportClient();
                    api.SqlDefinitionParameterPOST(sqlTanimParametre);
                }
                catch (ApiException exception)
                {
                    UtilMessage.Show(exception.Message);
            ...
            foreach (var keyValuePair in this.kosulDictionary)
            {
                ...
                sqlTanimParametre.Sql= keyValuePair.Key.Sql;
                ...
                {
                    var api = new RoyaleSupportClient();
                    api.SqlDefinitionConditionPOST(sqlTanimParametre);
                }
                catch (ApiException exception)
                {
                    UtilMessage.Show(exception.Message);
        ...
        {
            DataSet dataSet = this.ExecuteSql(this.richEditControlSorgu.Text.ToString(), this.paramDictionary);
        ...
        public DataSet SqlCalistir(string sql, List<SqlDefinitionParameterDto> parameters)
        {
            ...
            try
            {
                foreach (SqlDefinitionParameterDto parameter in parameters)
                {
                    EnumSqlParametreTipi parametreDbTipi = (EnumSqlParametreTipi)parameter.ParameterDbType;
                    SqlParameter sqlParameter1 = new SqlParameter(parameter.Name, (object)parameter.ParameterDbValue);
                    sqlParameter1.DbType = EnumSqlParametreTipiConverter.ToDbType(parametreDbTipi);
                    SqlParameter sqlParameter2 = sqlParameter1;
                    storeCommand.Parameters.Add((object)sqlParameter2);
        ...
        private void ParameteTipleriniBelirle()
        {
            ...
            foreach (string matchesParameter in this.matchesParameters)
            {
                ...
                UserControlParamaterAndValue paramaterAndValue = new UserControlParamaterAndValue(parametreAdi, sqlTanimParametre.Title, false, (byte)sqlTanimParametre.ParameterDbType);
        ...
        private void lookUpEditVeritabani_EditValueChanged(object sender, EventArgs e)
        {

        }

        private void layoutControlForm_Click(object sender, EventArgs e)
        {

        }

        private void xtraScrollableControlKosullar_Click(object sender, EventArgs e)
        {

        }

        private void richEditControlSorgu_Click(object sender, EventArgs e)
        {

        }

        private void bindingSourceSqlEkran_CurrentChanged(object sender, EventArgs e)
        {
        ...
        private void textEditAciklama_EditValueChanged(object sender, EventArgs e)
        {

        }

        private void lookUpEditSqlTanimKategori_EditValueChanged(object sender, EventArgs e)
        {

        }

        private void xtraScrollableControlParametreler_Click(object sender, EventArgs e)
        {

        }

        private void textEditBaslik_EditValueChanged(object sender, EventArgs e)
        {
        ...
        private void gridControlParametreler_Click(object sender, EventArgs e)
        {

        }

        private void bindingSourceShard_CurrentChanged(object sender, EventArgs e)
        {

        }

        private void bindingSourceSqlTanimListe_CurrentChanged(object sender, EventArgs e)
        {
