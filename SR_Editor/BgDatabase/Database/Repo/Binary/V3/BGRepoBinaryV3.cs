/*
<copyright file="BGRepoBinaryV3.cs" company="BansheeGz">
...
{
    /// <summary>
    /// version 3 reader/writer
    /// Changes:
    /// 1) Fields can have custom value->string, string->value formatter
    /// 2) Fields can have custom editor
    /// </summary>
