/*
<copyright file="BGRepoBinaryV7.cs" company="BansheeGz">
...
{
    /// <summary>
    /// version 7 reader/writer
    /// Changes:
    /// 1) views are added
    /// </summary>
    public class BGRepoBinaryV7 : BGRepo.RepoReaderI, BGRepo.RepoWriterI
    {
        private const int MyVersion = 7;
