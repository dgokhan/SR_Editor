/*
<copyright file="BGFieldViewRelationMultiple.cs" company="BansheeGz">
...
namespace BansheeGz.BGDatabase
{
    ...
    {
        public const ushort CodeType = 98;
        ...
        public BGFieldViewRelationMultiple(BGMetaEntity meta, string name, BGMetaView to) : base(meta, name, new List<BGMetaEntity>(){meta})
        {
            if (to == null)
            {
        ...
        internal BGFieldViewRelationMultiple(BGMetaEntity meta, BGId id, string name) : base(meta, id, name)
        {
        }
        ...
        //================================================================================================
        /// <inheritdoc/>
        protected override Func<BGMetaEntity, BGId, string, BGField> CreateFieldFactory() => (meta, id, name) => new BGFieldViewRelationMultiple(meta, id, name);
